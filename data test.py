...
#Full OONI data pipeline and reproducible analysis
class OoniDataPipeline:
    ...
    def flatten_ooni_docs(self, docs: List[Dict[str, Any]]) -> pd.DataFrame:
        ...
        for doc in docs:
            ...
            #counting num of unique dns revolvers
    ...
    #bar chart of proxy detection rates by country
    ...
    #web accessibility success rate by day
    ...
    #bar chart of top 8 common test types
    ...
    #how many unique dns revolvers each test used
